...
class SequentialActionObservationReplanner(
    ...
    override fun planNext(context: AgentObservationReplanContext): AgentObservationReplan? {
        ...
        val nextInput = context.run.input.explicitNextActionText() ?: return null
    ...
    private fun String.explicitNextActionText(): String? {
        val match = SEQUENCE_CONNECTOR.find(this) ?: return null
