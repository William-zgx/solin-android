...
val e4bChunk = ChunkSpec(
    assetFileName = "chunks/gemma-4-E4B-it.litertlm.part000",
    offset = 0L,
    byteSize = 1_900_000_000L,
)
...
android {
    namespace = "com.bytedance.zgx.pocketmind.modelpack.e4b"
    compileSdk = 36
...
val prepareBundledModelsAssets by tasks.registering(PrepareModelPackAssetsTask::class) {
    description = "Prepare the first E4B model chunk for the bundledModels variant."
    ...
    inputs.property("bundledModelLayout", "split-modelpack-e4b-chunk-v1")
